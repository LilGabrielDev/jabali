...
<img src="utils/bot_image.jpg" alt="Jabali md" width="260">

</div>

Jabali md is a WhatsApp MD bot built on top of the **Baileys** library.  
...
<a href="https://github.com/LilGabrielDev/jabali/fork" target="_blank">
...
> This creates your own copy of `jabali` under your GitHub account.
...
<a href="https://lilgabrielsession.onrender.com/" target="_blank">
...
```bash
git clone https://github.com/LilGabrielDev/jabali
cd jabali
```
...
- **Lil Gabriel Dev** – Main developer & maintainer  
...
Copyright (c) **2026 Lil Gabriel Dev**.  
All rights reserved.
