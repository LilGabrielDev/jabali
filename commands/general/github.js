...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/LilGabrielDev/jabali';
            const apiUrl = 'https://api.github.com/repos/LilGabrielDev/jabali';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* jabali\n`;
                fallbackMessage += `👨‍💻 *Owner:* LilGabrielDev\n`;
